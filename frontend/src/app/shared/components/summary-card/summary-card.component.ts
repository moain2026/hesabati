  ...
  template: `
    <div class="valex-card p-4 flex items-center gap-4">
      ...
      <div class="min-w-0 flex-1">
        <div [class.text-2xl]="valueSize === 'lg'" [class.text-base]="valueSize === 'sm'" class="font-bold truncate">
...
export class SummaryCardComponent {
  ...
  @Input() color: 'primary' | 'success' | 'warning' | 'danger' | 'info' | 'secondary' | 'accent' = 'primary';
